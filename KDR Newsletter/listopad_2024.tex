...
\pagebreak
\clanek{Bránění při výhozu}{Připomenutí pravidel a jejich aplikace}
...
\clanek{Neopatrná a bezohledná hra}{Výklad pravidel o hře florbalkou}
...
\clearpage
\clanek{Elektronický zápis}{Novinky a změny}
...
\clearpage
\clanek{Doplnění hráče}{do elektronického zápisu o utkání}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item zbarvené \textcolor{cfred}{\textbf{červeně}}, nemá uhrazený členský poplatek a nemůžete ho tak připustit k utkání.
	\end{itemize}
	\begin{figure}[h]
		\centering
